...
public class Revisao_E02_Sonic {
    public static void main(String[] args) {
        ...
        int novosAliados, esperanca = 0, medo = 0;
        int desafio1, desafio2, desafio3, confianca = 0, desanimo = 0;
        double media;
        ...
        +"\nPontos de esperanca: " + esperanca
        + "\nPontos de Medo: " + medo
        + "\nPontos de confianca: " + confianca
        + "\nPontos de Desânimo: " + desanimo
        + "\nPontos de Determinação: " + determinacao
        + "\nPontos de Incerteza: " + incerteza
        );

        positivos = esperanca + confianca + determinacao;
